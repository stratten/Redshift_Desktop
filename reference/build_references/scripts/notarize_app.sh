...
# Configuration
DEVELOPER_ID="D4X8TSBQJC"  # Your team ID
BUNDLE_ID="com.stratten.basil"

# Credential Details (for reference):
# Apple ID: stratten@baobabpartners.com
# Team ID: D4X8TSBQJC
# App-Specific Password: "Basil Notarization" (created from Apple ID account)
# Keychain Profile: "notarytool-password" (stored via: xcrun notarytool store-credentials)
